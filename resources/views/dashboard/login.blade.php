            ...
            <div class="login-container">
                ...
                @csrf
                    <div class="form-group">
                        <label for="username">STUDENT REG NUMBER</label>
                        <input type="text" name="regno" id="regno" class="form-control mb-2" placeholder="Enter your registration number">
                        @if($errors->has('regno'))
                        <span class="errormsg alert alert-danger text-danger">{{ $errors->first('regno') }}</span>
                        @endif
                    </div>
                    <div class="form-group">
