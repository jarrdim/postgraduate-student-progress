...
<div class="mt-2 h5 text-center font-weight-bold text-success"> APPROVED DOCUMENTS</div>
  <div class="card-body table-responsive p-0">
    <table id="deantable1" class="table   table-striped table-hover text-nowrap">
      <thead>
        <tr>
          <th>ID</th>
          <th>Student No</th>
...
<div class="container mt-3 mb-4 card" >
  ...
  <div class="card-body table-responsive p-0">
    ...
    <table id="deantable2" class="table    table-hover text-nowrap">
...
<div class="container mt-3 mb-4 card ">
  ...
  <div class="card-body table-responsive p-0">
    ...
    <table id="deantable3" class="table    table-hover text-nowrap">
...
<script>
  ...
  $(document).ready(function () {
    $('#deantable1').DataTable();
  
    
    
    $('#deantable2').DataTable();
    $('#deantable3').DataTable();
  });
  ...
  function approve(id) {
    ...
    var userResponse = window.confirm("Do you want to continue?");
      if (userResponse) {
        ...
        //alert("You clicked OK. Continuing the process.");
      } else {
